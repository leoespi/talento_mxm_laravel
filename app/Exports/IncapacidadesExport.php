...
class IncapacidadesExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    {
        return [
            'ID', 'Nombre del Usuario','Cedula', 'Dias de incapacidad', 'Fecha inicio incapacidad', 'Aplica cobro', 'Eps Afiliada', 'Tipo de incapacidad', 'Fecha de Creación', 'Fecha de Actualización'
        ];
    }
